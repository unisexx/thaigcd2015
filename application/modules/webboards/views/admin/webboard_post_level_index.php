		...
		<?php foreach ($webboard_post_levels as $webboard_post_level):?>
			<tr <?php echo cycle()?>>
				...
				<td>
					...
					<a class="btn" href="webboards/admin/webboard_post_levels/delete/<?php echo $webboard_post_level->id?>" onclick="return confirm('<?php echo lang('notice_confirm_delete');?>')">ลบ</a></td>
			</tr>
		<?php endforeach; ?>
