...
<h1>สื่อเผยแพร่</h1>
<form id="frmMain" action="mediapublics/admin/mediapublics/save/<?php echo $mediapublics->id?>" method="post" enctype="multipart/form-data">
<table class="form">
	<tr class="trlang"><th></th><td class="lang"><a href="th" class="active flag th">ไทย</a><a href="en" class="flag en">อังกฤษ</a></td></tr>
	<?php echo approver_dropdown($mediapublics);?>
	<?php echo approver_form($mediapublics);?>
	<tr>
		<th></th>
