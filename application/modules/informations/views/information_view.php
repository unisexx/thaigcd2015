...
$(function(){
	...
	<div id="data">
		...
		<?php if($information->refer): ?><div class="ref"><strong>ที่มา</strong> <span><?php echo $information->refer ?></span></div><?php endif; ?>
		<div class="ref"><strong>โดย </strong> <span><?php echo ($information->user->profile->first_name=="")?'Administrator':$information->user->profile->first_name.' '.$information->user->profile->last_name.' '.$information->user->profile->position?></span></div>  
		<div class="ref"><strong>กลุ่มงาน </strong> <span><?php echo ($information->group_id)?lang_decode($information->group->name):lang_decode($information->user->group->name) ?></span></div>        
		<?php if($information->tag): ?><div class="tag"><strong>แท็ก :</strong> <span><?php echo tag_decode($information->tag) ?></span></div><?php endif; ?>
...
<div style="padding:0 10px 10px;">
	...
	<form id="frmComment" action="informations/comment/<?php echo $information->id?>" method="POST">
		<table>
			<?php if($this->session->userdata('id')): ?>
			<tr><th style="width:150px;">ชื่อ : </th><td><?php echo login_data('display')?></td></tr>
			<?php else: ?>
			<tr><th style="width:150px;">ชื่อ : </th><td><input type="text" name="name" class="textbox" value=""></td></tr>
			<?php endif; ?>
			<tr><th></th><td><img src="users/captcha" /></td></tr>
			<tr><th>ตัวเลข : </th><td><input type="text" name="captcha" class="captcha"> </td></tr>
...
<div id="comment">
	...
	<li>
		...
		<div class="option">
			...
			<a href="informations/commentdel/<?php echo $comment->id?>">ลบ</a> 
			<?php endif; ?>

			<a href="informations/alert/<?php echo $comment->id?>?iframe=true&amp;width=350&amp;height=200" rel="lightbox" >แจ้งลบความคิดเห็น</a>
		</div>
