...
<form action="notices/admin/notices/save/<?php echo $notice->id ?>" method="post" >
<table class="form">
	...
	<tr><th></th><td><img class="img" style="width:77px; height:64px;" src="<?php echo ($notice->image)? $notice->image : 'media/images/dummy/77x64.gif' ?>"  /></td></tr>
	<tr><th>รูปภาพ :</th><td><input type="text" name="image" value="<?php echo $notice->image ?>" /><input type="button" name="browse" value="เลือกไฟล์" onclick="browser($(this).prev())" />[77 x 64 px]</td></tr>
	<tr><th>สถานะ :</th><td><?php echo form_dropdown('category_id',$notice->category->get_option(),$notice->category_id,'');?></td></tr>
	<tr><th>เริ่ม :</th><td><input type="text" name="start_date" value="<?php echo $notice->start_date?>" class="datepicker" /></td></tr>
	<tr><th>สิ้นสุด :</th><td><input type="text" name="end_date" value="<?php echo $notice->end_date?>" class="datepicker" /></td></tr>
	<tr>
		<th>เริ่มการยื่นซองสอบราคา :</th>
		<td><input type="text" name="start_notice" value="<?php echo $notice->start_notice?>" class="datepicker" /></td>
	</tr>
	<tr>
		<th>สิ้นสุดการยื่นซองสอบราคา :</th>
		<td><input type="text" name="end_notice" value="<?php echo $notice->end_notice?>" class="datepicker" /></td>
	</tr>
	<tr>
		<th>วันเปิดซอง :</th>
		<td>
			<input type="text" name="open_date" value="<?php echo $notice->open_date?>" class="datepicker" />
		</td>
	</tr>
	<tr>
		<th>ร่วมสังเกตการณ์ :</th>
		<td>
			<input type="text" name="observe_date" value="<?php echo $notice->observe_date?>" class="datepicker" />
		</td>
	</tr>
	<tr>
		<th>สถานที่ :</th>
	...
	<tr><th></th><td><input type="submit" value="บันทึก"><input type="button" name="back" value="ย้อนกลับ" onclick="window.location = 'notices/admin/notices'"></td></tr>
</table>
</form>