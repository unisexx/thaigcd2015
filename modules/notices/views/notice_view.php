	...
	<tbody>
        ...
        <tr>
                      ...
                      <table class="tbnotify">
                        ...
                        <td width="80%"><input type="text" class="textboxNotifyOffer" id="textfield" name="textfield"></td>
                        </tr>
                        <tr>
                        <td><strong>บริษัท</strong></td>
                        <td><input type="text" class="textboxNotifyOffer" id="textfield2" name="textfield2"></td>
                        </tr>
                        <tr>
                        <td><strong>หัวเรื่อง</strong></td>
                        <td><input type="text" class="textboxNotifyOffer" id="textfield3" name="textfield3"></td>
                        </tr>
                        <tr>
                        <td valign="top"><strong>เนื้อหาเสนอแนะ</strong></td>
                        <td><textarea class="textboxNotifyOffer" id="textfield4" rows="6" name="textfield4"></textarea></td>
                        </tr>
                        <tr>
                        <td><strong>อีเมล์</strong></td>
                        <td><input type="text" class="textboxNotifyOffer" id="textfield5" name="textfield5"></td>
                        </tr>
                        <tr>
                          <td><strong>เบอร์ติดต่อ</strong></td>
                          <td><input type="text" class="textboxNotifyOffer" id="textfield6" name="textfield6"></td>
                        </tr>
                        <tr>
                        <td style="border: 0pt none;">&nbsp;</td>
                        <td style="border: 0pt none;"><input type="submit" value="ส่งข้อมูล" id="button2" name="button2"></td>
                        </tr>
                        </tbody></table>
             </div><!--offer-->
			 			<?php endif; ?>
