	...
	<div id="data">
		<h2 style="color:#006600;">ค้นหาจาก tag : <?php echo $tag ?></h2>
			...
			<div class="box-tag"> 
				<a href="knowledges/view/<?php echo $knowledge->id ?>" class="thumb"><img class="photo" src="<?php echo ($knowledge->image)? $knowledge->image : 'themes/thaigcd/photo/nophoto.gif' ?>" width="77" height="64" /></a>
