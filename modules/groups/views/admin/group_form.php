...
<h1>กลุ่มงาน</h1>
<form action="groups/admin/groups/save/<?php echo $group->id ?>" method="post" >
<table class="form">
	<tr class="trlang"><th></th><td class="lang"><a href="th" class="active flag th">ไทย</a><a href="en" class="flag en">อังกฤษ</a></td></tr>
	<?php if($group->image): ?>
	<tr><th></th><td><img class="img" style="width:644px; height:254px;" src="<?php echo $group->image ?>" /></td></tr>
	<?php endif; ?>
	<tr><th>รูปภาพ :</th><td><input type="text" name="image" value="<?php echo $group->image ?>" /><input type="button" name="browse" value="เลือกไฟล์" onclick="browser($(this).prev(),'images')" />[644 x 254 px]</td></tr>
	<tr>
		<th>กลุ่ม :</th>
		<td>
