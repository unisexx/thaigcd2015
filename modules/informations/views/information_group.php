	...
	<div id="data">
			...
			<div class="box-tag"> 
				<a href="informations/view/<?php echo $information->id ?>" class="thumb"><img class="photo" src="<?php echo ($information->image)? $information->image : 'themes/thaigcd/photo/nophoto.gif' ?>" width="77" height="64" /></a>
