<div class="title">
	<h2><?php echo $blog->blogpost->title ?></h2>
	<span>
...
<div id="commentform">
	...
	<form action="blogs/comment/<?php echo $blog->blogpost->id?>" method="POST">
		<table>
			...
			<?php else: ?>
			<tr><th style="width:150px;">name : </th><td><input type="text" name="cn" class="textbox" value=""></td></tr>
			<?php endif; ?>
...
<div id="comment">
	...
	<li>
		<div class="info">
			...
			<img src="uploads/users/thumbs50x50/<?php echo $blogcomment->user->profile->avatar ?>" />
